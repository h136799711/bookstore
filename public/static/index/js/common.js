...
(function($, w) {
    ...
    $(function() {
        console.log("INIT COMMON JS START");
        NProgress.start();
        if (!window.itboye) {
            window.itboye = {};
        }
        ...
        $('.ajax-post').click(function() {
            ...
            if ($(this).hasClass('confirm')) {
                if(!window.itboye) window.itboye = {};
                window.itboye.ajax_post_params = {
                    that:that,
                    target:target,
                    query:query
                };
                $(this).scojs_confirm({
                    content: '确认要执行该操作吗',
                    action: function() {
                        myUtils.ajaxpost(window.itboye.ajax_post_params.that, window.itboye.ajax_post_params.target, window.itboye.ajax_post_params.query);
                    }
                }).show();
            } else {
        ...
        $(window).resize();
        console.log("INIT COMMON JS END");
    }) //end $.ready
