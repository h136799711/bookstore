...
return [
    ...
    'err_device_not_online'=>'[10011]设备未上线',
    'err_invalid_did'=>'[10012] 请检查设备DID是否输入正确',
    "err_email"=>"请输入正确的邮箱",
    "err_status_0"=>'已被禁用',
    "err_status_-1"=>'已被删除',
	...
	"err_qcloud_1001"=>"sig校验失败",
	"err_qcloud_1002"=>"短信/语音内容中含有敏感词",
	"err_qcloud_1003"=>"请求包体没有sig字段或sig为空",
	"err_qcloud_1004"=>"请求包解析失败，通常情况下是由于没有遵守API接口说明规范导致的",
	"err_qcloud_1006"=>"请求没有权限，比如没有扩展码权限等",
    ...
    "err_qcloud_1020"=>"sdkappid已禁用",
    "err_qcloud_1021"=>"请求发起时间不正常，通常是由于您的服务器时间与腾讯云服务器时间差异超过10分钟导致的",
    "err_qcloud_1022"=>"业务短信日下发条数超过设定的上限",
    "err_qcloud_1023"=>"单个手机号30秒内下发短信条数超过设定的上限",
    "err_qcloud_1024"=>"单个手机号1小时内下发短信条数超过设定的上限",
    "err_qcloud_1025"=>"单个手机号日下发短信条数超过设定的上限",
    "err_qcloud_1026"=>"单个手机号下发相同内容超过设定的上限",
    "err_qcloud_1030"=>"不支持该请求",
    "err_qcloud_1031"=>"套餐包余额不足",
    "err_qcloud_1032"=>"个人用户没有发营销短信的权限",
    "err_qcloud_1033"=>"欠费停止服务",
